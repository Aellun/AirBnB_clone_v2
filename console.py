...
class HBNBCommand(cmd.Cmd):
    ...
    def emptyline(self):
        """
        When an empty line is entered, no action taken.
        """
        pass
    ...
    def do_show(self, arg):
        """
        Show the str rep of an instance.
        """
    ...
    def do_count(self, arg):
        """
        Count and retrieve the number of class instances
        """
        objects = storage.all()
    ...
    def default(self, arg):
        """
        This is how CMD module will behave when the input is invalid
        """
        arg_list = arg.split('.')
