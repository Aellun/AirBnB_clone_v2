#!/usr/bin/python3
"""This is unit tests for the module  Amenity class """
...
# Retrieving the storage type from the environment variable
storage_t = getenv("HBNB_TYPE_STORAGE")


class test_Amenity(test_basemodel):
    """test case for the class ammenity """

    def __init__(self, *args, **kwargs):
        """test_Amenity instance initialization """
...
# Class to test Amenity inheritance from BaseModel
...
# Class to test the Amenity and BaseModel relationship
